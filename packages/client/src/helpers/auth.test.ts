...
import { SessionData, fetchOrRenewSession, refreshAuthData, transformSessionToAuth } from './auth';
...
describe('Auth helpers', () => {
	...
	describe('transformSessionToAuth', () => {
		it('correctly uses expire_in_seconds when transforming to local time', () => {
			...
			expect(authData.sessionExpireAtLocal).toBe('2021-10-10T11:10:00.000Z');
			expect(authData.tokenExpireAtLocal).toBe('2021-10-10T10:40:00.000Z');
		});
	});
