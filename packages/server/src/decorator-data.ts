...
import { clientParamKeys, ClientParams, Language, Params, validateRawParams } from 'decorator-shared/params';
...
const storageDictionary: Set<AllowedStorageItem> = new Set([
	...
	},
	{
		...
		type: ['sessionstorage'],
		service: 'Tiltaksgjennomføring',
		description: 'Lagre hvilken virksomhet en arbeidsgiver har valgt i bedriftsvalgmenyen',
		optional: false,
	},
	{
		name: 'klang-*',
	...
	},
	{
		...
		type: ['localstorage'],
		service: 'Min side arbeidsgiver',
		description: 'Husker om brukeren har valgt å lukke infoboks, slik at denne ikke vises igjen ved hver sidelasting.',
		optional: false,
	},
	{
		name: 'skyra.state',
		type: ['cookie'],
		service: 'ResearchOps',
		description: 'Ved hjelp av denne kan Skyra huske brukeren og hvorvidt undersøkelser er åpne/lukket/fullført',
		optional: true,
	},
	{
		name: 'skyra*',
	...
	},
	{
		...
		type: ['localstorage'],
		service: 'Pensjon',
		description: 'Brukes for at mottaker skal kunne endre språk i skjema (NB/NN/EN)',
		optional: false,
	},
	{
		name: 'SESSION_PSELV',
	...
	},
	{
		...
		description: 'Husker hvilket filtreringsvalg som brukeren har gjort i menyene til neste besøk.',
		optional: false,
	},
	{
	...
	},
	{
		...
		type: ['localstorage'],
		service: 'Tiltaksarrangør',
		description: 'Husker siste viste informasjonsmelding fra Nav til neste besøk.',
		optional: false,
	},
	{
		...
		type: ['localstorage'],
		service: 'Tiltaksarrangør',
		description: 'Husker om brukeren har valgt å skjule siste informasjonsmelding.',
		optional: false,
	},
	{
		name: 'kontonr-result',
	...
	},
	{
		...
		type: ['cookie'],
		service: 'NKS / Innboks',
		description: 'Brukes til å anvende samtykkepreferanser for informasjonskapsler.',
		optional: false,
	},
	{
	...
	},
	{
		...
		type: ['sessionstorage'],
		service: 'NKS / Innboks',
		description: 'Sporer validering av Cross-Site Request Forgery for visse SSO-flyter',
		optional: false,
	},
	{
		name: 'inst',
	...
	},
	{
		...
		type: ['sessionstorage'],
		service: 'NKS / Innboks',
		description: 'Brukes til å oppdage og forhindre manipulering av sesjoner.',
		optional: false,
	},
	{
		name: 'oinfo',
	...
	},
	{
		...
		type: ['cookie'],
		service: 'NKS / Innboks',
		description: 'Tildeler unik ID til gjestebrukere i Experience Cloud-nettsteder, utløper ett år etter siste besøk.',
		optional: false,
	},
	{
	...
	},
	{
		...
		type: ['sessionstorage'],
		service: 'NKS / Innboks',
		description: 'Brukes for å skille de forskjellige enhetene som besøker siden fra hverandre.',
		optional: false,
	},
	{
		name: 'autocomplete',
		type: ['cookie'],
		service: 'NKS / Innboks',
		description: 'Bestemmer om innloggingssiden husker brukerens brukernavn.',
		optional: false,
	},
	{
		name: 'clientSrc',
...
const buildAllowedStorage = () => {
	const allAllowedStorage: PublicStorageItem[] = Array.from(storageDictionary).reduce((all, item) => {
...
const clientTexts = Object.fromEntries(
	(Object.keys(texts) as Language[]).map((language) => [
		language,
		Object.fromEntries(Object.entries(texts[language]).filter(([key]) => clientTextsKeySet.has(key))) as ClientTexts,
	])
...
export const buildDecoratorData = ({ features, params, rawParams, headAssets }: DecoratorDataProps): AppState => ({
