...
export const nb = {
	...
	consent_banner_change_consent: 'Du kan når som helst endre samtykket ditt via lenken i bunnmenyen.',
	consent_banner_additional_cookies_info: 'Vi har også nødvendige informasjonskapsler, som ikke kan velges bort.',
	consent_banner_additional_cookies_link: 'Om informasjonskapslene våre.',
	consent_banner_minimized: 'Velg hvilke informasjons&shy;kapsler Nav kan bruke.',
	clear: 'Tøm',
	login: 'Logg inn',
	logout: 'Logg ut',
	...
	session_warning_title: 'Du blir logget ut automatisk om ca. <span class="session-time-remaining">$1</span> minutter',
	...
	of: 'av',
	results: 'resultater',
	search_hits_heading: ({ total, query, context }: { total: number; query: string; context: Context }) =>
...
const en: Texts = {
	...
	consent_banner_change_consent: 'You can  change your consent at any time through the link in the footer menu.',
	consent_banner_additional_cookies_info: 'We also use essential cookies that you cannot opt out of.',
