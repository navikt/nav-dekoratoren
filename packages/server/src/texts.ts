...
const nb = {
    ...
    message: 'Beskjed',
    task: 'Oppgave',
    masked_message_text: 'Du har fått en melding, logg inn med høyere sikkerhetsnivå for å se meldingen.',
    masked_task_text: 'Du har fått en oppgave, logg inn med høyere sikkerhetsnivå for å se oppgaven.',
    archive: 'Arkiver',
    ...
    no: 'Nei',
    ok: 'OK',
    hensikt_med_tilbakemelding: 'Du får dessverre ikke svar på tilbakemeldingen din. Har du spørsmål eller trenger du hjelp?',
    ...
    meny_bunnlenke_minside_stikkord: 'Dine saker, utbetalinger, meldinger, meldekort, aktivitetsplan, personopplysninger og flere tjenester',
    meny_bunnlenke_arbeidsgiver_stikkord: 'Dine sykmeldte, rekruttering, digitale skjemaer',
    meny_bunnlenke_samarbeidspartner_stikkord: 'Helsepersonell, tiltaksarrangører, fylker og kommuner',
    ...
    delskjerm_modal_hjelpetekst_0: 'Når du deler skjerm med NAV kontaktsenter kan veilederen hjelpe deg med å finne fram på nav.no.',
    delskjerm_modal_hjelpetekst_1: 'Veilederen ser kun det du ser på nav.no og kan ikke fylle inn opplysninger eller sende inn noe på dine vegne.',
    delskjerm_modal_hjelpetekst_2: 'Det er du som godkjenner skjermdeling. Ingenting blir lagret.',
    delskjerm_modal_stengt: 'Skjermdeling er for øyeblikket stengt, prøv igjen senere',
    security_level_info: 'Du har logget inn med Min ID. Hvis du logger inn med et høyere sikkerhetsnivå, får du se mer innhold og flere tjenester.',
...
export const texts: Record<Language, Texts> = {
    ...
    en: {
        ...
        notifications_empty_list_description: 'We will notify you when something happens.',
        ...
        message: 'Message',
        task: 'Task',
        masked_message_text: 'You have a message, please log in with a higher security level to read the message.',
        masked_task_text: 'You have a task, please log in with a higher security level to see the task.',
        archive: 'Archive',
        ...
        session_warning_title: 'You will be logged out automatically in about $1 minutes',
        session_warning_body: 'Avslutt det du jobber med og logg inn igjen.',
        yes: 'Yes',
        no: 'No',
        ok: 'OK',
        hensikt_med_tilbakemelding: 'Unfortunately you will not get a reply to your feedback. Do you have questions or need help?',
        ...
        meny_bunnlenke_minside_stikkord: 'Your cases, payments, messages, report cards, activity plan, personal information and more services',
        meny_bunnlenke_arbeidsgiver_stikkord: 'Your sick leave, recruitment, digital forms',
        ...
        delskjerm_modal_hjelpetekst_2: 'Screen sharing must be approved by you. Nothing is stored.',
