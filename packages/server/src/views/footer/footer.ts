...
export const FooterTemplate = async ({ params, features, withContainers }: FooterProps): Promise<Template> => {
	const { shareScreen, feedback, simple, simpleFooter, language, context } = params;
	...
	const footerContent = html`
		...
		<d-chatbot></d-chatbot>
		${LogoutWarning()} ${feedback ? Feedback({ contactUrl: CONTACT_URL }) : undefined}
		${
			simple || simpleFooter
				? SimpleFooter({
