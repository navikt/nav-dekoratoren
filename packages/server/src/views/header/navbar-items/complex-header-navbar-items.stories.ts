...
import type { ComplexHeaderNavbarItemsProps } from './complex-header-navbar-items';
import { ComplexHeaderNavbarItems } from './complex-header-navbar-items';

const meta: Meta<ComplexHeaderNavbarItemsProps> = {
  title: 'header/complex-navbar-items',
  tags: ['autodocs'],
  render: ComplexHeaderNavbarItems,
};

export default meta;
type Story = StoryObj<ComplexHeaderNavbarItemsProps>;
