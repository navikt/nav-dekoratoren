...
import { PersonCircleIcon, PersonCircleNotificationIcon } from 'decorator-icons';
...
export const UserMenuDropdown = ({
	...
	return DropdownMenu({
		button: HeaderButton({
			...
			icon: notifications && notifications.length > 0 ? PersonCircleNotificationIcon({}) : PersonCircleIcon({}),
		}),
