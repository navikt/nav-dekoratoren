			...
			hits: [
				{
					...
					highlight: 'Erstatter inntekten din når du ikke kan jobbe på grunn av sykdom eller skade.',
				},
				{
				...
				{
					displayName: 'Sykepengesøknaden og behandling av personopplysninger',
				...
				{
					displayName: 'Dokumentasjon for sykepenger når du bor i utlandet',
				...
				{
					displayName: 'Søknad om sykepenger for arbeidstakere (NAV 08-07.04D)',
