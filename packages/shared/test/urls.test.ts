...
test('Frontpage URLs', () => {
	...
	expect(makeFrontpageUrl({ language: 'en', context: 'privatperson', baseUrl })).toBe('https://www.nav.no/en/home');
	expect(makeFrontpageUrl({ language: 'nb', context: 'privatperson', baseUrl })).toBe('https://www.nav.no/');
	expect(makeFrontpageUrl({ language: 'nb', context: 'arbeidsgiver', baseUrl })).toBe(
