...
testWithUmamiMock('Breadcrumbs without analyticsTitle should send [redacted] as lenketekst', async ({ page }) => {
...
testWithUmamiMock('Breadcrumbs with analyticsTitle should use analyticsTitle as lenketekst', async ({ page }) => {
	await setBreadcrumbs(page, [
		{
			title: 'Ola Nordmann',
